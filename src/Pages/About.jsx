...
function About() {
  ...
  founder: [{
    ...
    image: founder,
    role: "Founder",
    description: "Rich Heritage Yoga Centre Yogacharya In yoga YCB LEVEL 6 (YM) RYT 200 (YOGA ALLIANCE INTERNATIONAL) Medical Yoga therapist  Music therapist Dietitian B.A YOGAVISHARAD CCY (KAIVALYADHAM) Diploma in Pharmacy",
  },
   {
    name: "Soniya Raj",
    image: team,
    role: "Lead Trainer",
    description: "Rich Heritage Yoga Centre M.A in Yoga (SPPU) YCB LEVEL 3 RYT 200 (YOGA ALLIANCE INTERNATIONAL) Medical Yoga therapist  Pregnancy Yoga Teacher  IATA Graduate",
  },]
  ...
  return (
    <div className='about' id='about'>
     ...
     <li> Workshops and Yoga Retreat. </li>
      ...
      explanation for all A sanas and K riyas. Personalized plan for yoga therapy.</li>
...
our clients, at par to International 
standards.
        </p>
      </div>
    </div>
